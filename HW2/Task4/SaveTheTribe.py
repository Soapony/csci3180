...
class save_the_tribe():
    ...
    def initialize(self):
        self.__monsters.append(Monster(1,random.randint(0,4)*10+30))
        self.__monsters[0].set_pos(4,1)
        self.__monsters[0].add_drop_item(2)
        self.__monsters[0].add_drop_item(3)

        self.__monsters.append(Monster(2,random.randint(0,4)*10+30))
        ...
        self.__monsters.append(Monster(7,random.randint(0,4)*10+30))
    ...
    def start(self):
        ...
        while(self.__game_enabled):
            ...
            if(self.__map.check_move(new_row,new_col)):
                ...
                if(type(occupied_object) is Monster):
